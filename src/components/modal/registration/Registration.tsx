          ...
          <form onSubmit={handleSubmit(postReg)}>
            <div className="modalReg__fullName">
              ...
              <div className="modalReg__context">
                {errors?.fullName && <p>{errors?.email?.fullName || "Поле обязательно!"}</p>}
              </div>
            </div>
            <div className="modalReg__inputEmail">
              ...
              <input {...register("email", {
                ...
                className="modalReg__input" />
              <div className="modalReg__context">
                {errors?.email && <p>{errors?.email?.message || "Поле обязательно!"}</p>}
              </div>
            </div>
            <div className="modalReg__inputPassword">
              ...
              <input {...register("password", {
                ...
                className="modalReg__input" />
              <div className="modalReg__context">
                {errors?.password && <p>{errors?.password?.message || "Поле обязательно!"}</p>}
              </div>
            </div>
