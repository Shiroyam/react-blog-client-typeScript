        ...
        <div className="profile">
            <div className="profile__container">
                <div className="profile__headerContainer">
                    <div className="profile__header">{localStorage.getItem("name")}</div>
                </div>
                <div className="profile__toggle">
                    <div onClick={() => dispatch(togglePosts())} className={toggleFlag ? "profile__togglePosts open" : "profile__togglePosts"}>Статьи</div>
                    <div onClick={() => dispatch(toggleComments())} className={!toggleFlag ? "profile__toggleComments open" : "profile__toggleComments"}>Комментарии</div>
                </div>
                {toggleFlag ? <>
