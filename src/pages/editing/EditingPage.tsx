                ...
                <form onSubmit={handleSubmit(onSubmitHandlear)} >
                    ...
                    <div className="create__descriptionContainer">
                        ...
                        <textarea
                            ...
                            className="create__input">{post.description}</textarea>
                        <div className="create__context">
                        ...
                        <div className="create__form">
                            <div className="create__container">
                                <textarea
                                    ...
                                    className="create__input">{post.photoUrl}</textarea>
                                <button disabled className="create__button">Загрузить</button>
                            </div>
                            <div className="create__context">
                                {errors?.photoUrl && (
                    ...
                    <div className="create__textContainer">
                        ...
                        <textarea
                            ...
                            className="create__input">{post.text}</textarea>
                        <div className="create__context">
                            {errors?.text && <p>{errors?.text?.message || "Error!"}</p>}
                        </div>
                    </div>
                    <button type="submit" className="create__button">Изменить</button>
                </form>
            </div>
        </>
    );
